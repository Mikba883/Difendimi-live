...
export default function NewCase() {
  ...
  useEffect(() => {
    ...
    setMessages([{
      id: '1',
      text: "Ciao! Sono Lexy, il tuo assistente AI esperto di Diritto. Racconta in modo semplice e completo la situazione che vuoi risolvere. Dopo la tua descrizione, ti farò alcune domande mirate per completare l'analisi.",
      sender: 'assistant',
      timestamp: new Date()
    }]);
  }, []);
